...
const MenPage = () => {
  ...
  const filterOptions = ["all", "shirts", "jeans", "jacket"];

  return (
    <section className="min-h-screen bg-gradient-to-br from-white via-green-50 to-white font-poppins">
      <Helmet>
        <title>Men’s Collection – EcoWear</title>
        <meta
          name="description"
          content="Discover sustainable men's fashion. Eco‑friendly shirts, jeans, and jackets made from organic materials. Free shipping on orders over ₹1000."
        />
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        >
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Sustainable style that respects the planet and your wardrobe
          </p>
          <p className="text-sm text-gray-400 mt-2">
            {menProducts.length} {menProducts.length === 1 ? "item" : "items"}
          </p>
        </motion.div>
