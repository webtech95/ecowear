...
const KidsPage = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-white via-green-50 to-white font-poppins">
      <Helmet>
        <title>Kids Collection – EcoWear</title>
        <meta
          name="description"
          content="Discover sustainable kids clothing: organic jackets, jeans, and shirts. Eco‑friendly fashion for the little ones."
        />
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        >
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Soft, safe, and sustainable styles for the little ones
          </p>
          <p className="text-sm text-gray-400 mt-2">
            {kidsProducts.length} {kidsProducts.length === 1 ? "item" : "items"}
          </p>
        </motion.div>
